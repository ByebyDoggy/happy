...
export const ru: TranslationStructure = {
    ...
    sessionCategories: {
        ...
        notLoaded: 'Категории ещё загружаются. Проверьте соединение и попробуйте снова.',
        conflict: 'Изменение столкнулось с другой правкой категорий. Попробуйте снова.',
        tooDeep: 'Категории могут быть вложены не более чем на три уровня.',
        noneYet: "У вас пока нет категорий. Создайте её в строке категорий над списком сессий.",
        emptyTitle: 'В этой категории ничего нет',
        emptyBody: ({ name }: { name: string }) => `Ни одна сессия не отнесена к «${name}». Переместите её сюда из меню долгого нажатия или снимите фильтр выше, чтобы увидеть всё.`,
    },
