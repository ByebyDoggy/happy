...
export const ru: TranslationStructure = {
    ...
    sessionCategories: {
        ...
        notLoaded: 'Это устройство ещё не загрузило ваши категории. Проверьте соединение и попробуйте снова.',
        conflict: 'Другое устройство изменило категории раньше — ваше изменение не применено. Попробуйте снова.',
